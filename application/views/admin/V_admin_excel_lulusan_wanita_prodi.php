            ...
            <tbody>
                <?php
                    ...
                    foreach($hitung_prodi as $hp){
                        ...
                        $tahun_lulus = $this->db->query("select * from akun_alumni inner join tracer_study on akun_alumni.id_alumni = tracer_study.id_alumni where akun_alumni.j_kelamin = 'Wanita' and akun_alumni.program_studi = '".$tl."' and tracer_study.sts_kerja = 'Sudah' order by akun_alumni.tahun_lulus asc")->result();
