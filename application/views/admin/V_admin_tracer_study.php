            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="page-header">
                        ...
                        <?php
                            if($this->session->flashdata("pesan_feedback") <> ""){
                                echo ' <div class="alert alert-warning">'.$this->session->flashdata("pesan_feedback").'</div>';
                            }
                        ?>
                    </div>
                        ...
                        <table class="table table-striped table-hover" id="sample_2">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><a class="btn btn-xs btn-green" href="<?php echo site_url(); ?>c_career_center_admin/feedback_alumni/<?php echo $row->id_alumni; ?>" class="delete-row"><i class="fa fa-reply"></i></a></td>
                                </tr>
