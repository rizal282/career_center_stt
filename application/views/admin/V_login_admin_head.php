...
<head>
    <title>PUSAT KARIR STT WASTUKANCANA</title>
    ...
    <script type="text/javascript" src="<?php echo base_url(); ?>lib_career_center/adm_career_center/assets/js/highcharts.js"></script>-->
    <script src="https://code.jquery.com/jquery-3.1.1.min.js"></script>
    <script src="https://code.highcharts.com/highcharts.js"></script>
    <script src="https://code.highcharts.com/modules/data.js"></script>
    <script src="https://code.highcharts.com/modules/exporting.js"></script>
    <script src="https://code.highcharts.com/modules/export-data.js"></script>
    <script type="text/javascript" src="<?php echo base_url(); ?>lib_career_center/adm_career_center/jquery-ui-1.12.1/jquery-ui.min.js"></script>
    <!--<![endif]-->
    ...
    <script src="<?php echo base_url(); ?>lib_career_center/adm_career_center/PDFObject-master/pdfobject.js"></script>
    <script type="text/javascript" src="http://github.com/malsup/media/raw/master/jquery.media.js?v0.92"></script> 
    <script type="text/javascript" src="https://gist.githubusercontent.com/kieranj/153957/raw/fa56ae395f91b4d752898913314d2ebd6996520f/jquery.metadata.js"></script> 
                ...
                <ul class="nav navbar-right">                  
                    ...
                    <li class="dropdown current-user">
                        ...
                        <ul class="dropdown-menu">
                                <li>
                                    <a href="<?php echo site_url(); ?>c_main_career_center/logout_admin">
