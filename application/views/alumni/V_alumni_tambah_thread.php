                            ...
                            <div class="panel-body">
                                ...
                                <div class="table-responsive">
                                    <?php
                                        ...
                                        echo form_open('c_career_center_alumni/process_adding_thread', $attributes); 
                                    ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input name="nama_thread" type="text" placeholder="Nama Thread" id="form-field-1" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <textarea class="form-control" name="deskripsi_thread" id="" cols="30" rows="10"></textarea>
                                            </div>
                                        </div>
