                                    ...
                                    ?>
                                            ...
                                            <div id="detailpt">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-8">
                                                        <input type="text" name="keahlian" class="form-control" placeholder="Isi Keahlian Anda">
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                <label class="col-sm-4 control-label" for="form-field-1">
                                                    Bulan & Tahun Masuk Kerja Pertama
                                                </label>
                                                <div class="col-sm-8">
                                                    <input type="date" name="tahun_bulan_kerja" class="form-control">
                                                </div>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-8">
                                                    <textarea class="form-control" name="kritik_saran" id="" cols="30" rows="10"></textarea>
                                                </div>
                                            </div>
